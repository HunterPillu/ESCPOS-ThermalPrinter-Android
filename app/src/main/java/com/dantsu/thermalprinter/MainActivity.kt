...
import com.dantsu.escposprinter.connection.usb.UsbPrintersConnections.selectFirstConnected
import com.dantsu.escposprinter.textparser.PrinterTextParserImg.bitmapToHexadecimalString
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener { view: View? -> browseBluetoothDevice() }
        button = findViewById<View>(R.id.button_bluetooth) as Button
        button.setOnClickListener { view: View? -> printBluetooth() }
        button = findViewById<View>(R.id.button_usb) as Button
        button.setOnClickListener { view: View? -> printUsb() }
        button = findViewById<View>(R.id.button_tcp) as Button
        button.setOnClickListener { view: View? -> printTcp() }
    }
    ...
    fun printUsb() {
        val usbConnection = selectFirstConnected(this)
